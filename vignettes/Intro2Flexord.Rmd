...
can mitigate this risk by setting the $\alpha_2$ parameter
greater 0. With this, we add $\alpha_2$ observations which are equal
...
```{r ordinal_m2}
flexmix(risk~1,  k = 3, model = FLXMCbinomial(size = 5))
flexmix(risk~1, k = 3,
